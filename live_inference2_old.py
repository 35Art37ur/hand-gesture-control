...
Voraussetzung: train_model_old.py wurde bereits ausgefuehrt und hat ein
...
Aufruf (nutzt automatisch das ZULETZT trainierte Modell):
    python live_inference2_old.py

Aufruf mit einem bestimmten, aelteren Modell:
    python live_inference2_old.py --model modelle/model_003
...
def neuestes_modell_verzeichnis(basis_ordner):
    ...
    if not kandidaten:
        raise RuntimeError(
            ...
            f"Bitte zuerst train_model_old.py ausfuehren."
        )
